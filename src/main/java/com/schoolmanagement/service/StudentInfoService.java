...
public class StudentInfoService {
    ...
    public ResponseMessage<StudentInfoResponse> save(String username, StudentInfoRequestWithoutTeacherId studentInfoRequest) {
        ...
        // DTO ve request den gelen Student, Teacher, Lesson ve Education Term getiriliyor.
        //NOT  id verip bize pojo dönen methodlar lazım
        ...
        //Lesson çakışma var mı kontrolü
    ...
    private boolean checkSameLesson(Long studentId, String lessonName) {
        ...
        //StudentInfo tablosunda verdiğim studentid ile studentInfoları getir.Bu studentInfolardaki dersleri karsılastırıyor.
