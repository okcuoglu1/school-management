...
public class StudentService {
    ...
    public ResponseMessage<StudentResponse> save(StudentRequest studentRequest) {
        ...
        // !!! Response Nesnesi olusturuluyor - save methodu save edilen datayı döndürür bu dönen objeyi method parametresinde direk olarak kullanabilirim.
   ...
   public StudentResponse createStudentResponse(Student student) {
    ...
    // Not: getStudentById() ******************************************************
    //Not: Dönen değer service katmanında pojo ise bu başka bir service katmanında kullanılacağını gösterir.
