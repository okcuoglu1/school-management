...
@SuperBuilder //baseUserRequestten extend ettiğim bütün classlar bu classın fieldlarına builder methoduyla ulasabilsin.
@MappedSuperclass //db de tablo olusmadan base class olusturuyoruz.dbde olusacak bazı tablolar bu sınıfı kullansın istiyoruz.
@Data
@AllArgsConstructor
@NoArgsConstructor
public abstract class BaseUserRequest implements Serializable {
    ...
    @Past //girilen tarih eskiye dayalı bir tarih olup olmadığını kontrol ediyor.
